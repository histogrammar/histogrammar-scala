...
package histogrammar {
  ...
  object AbsoluteErr extends Factory {
    ...
    def unapply[DATUM](x: AbsoluteErring[DATUM]) = Some((x.count, x.mae))
  ...
  class AbsoluteErring[DATUM](val quantity: NumericalFcn[DATUM], val selection: Selection[DATUM], var count: Double, _mae: Double) extends Container[AbsoluteErring[DATUM]] with Aggregation {
