...
abstract class MetricSortedMap[A, B](elems: (A, B)*)(implicit val ordering: MetricOrdering[A]) extends SortedMap[A, B] {
...
// package immutable {
//   class MetricSortedMap[A, B](elems: (A, B)*)(implicit val ordering: MetricOrdering[A]) extends MetricSortedMap[A, B](elems: _*)(ordering) {
