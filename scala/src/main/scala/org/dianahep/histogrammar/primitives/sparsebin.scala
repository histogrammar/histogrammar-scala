...
package histogrammar {
  ...
  class SparselyBinning[DATUM, V <: Aggregator[DATUM, V], N <: Aggregator[DATUM, N]](
    val binWidth: Double,
    ...
    val nanflow: N,
    val origin: Double) extends Aggregator[DATUM, SparselyBinning[DATUM, V, N]] with SparselyBin.Methods {
    def factory = SparselyBin
